...
public class LifetimeSavings extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lifetimeSavingtxb.setText("$"+String.format("%.2f",lifetimeSaving));
		TextView lifetimeSpendingtxb = (TextView) findViewById(R.id.lifeTimeSpending);
		lifetimeSpendingtxb.setText("$"+String.format("%.2f",lifetimeSpending));
		
		//Set the lifetime saved counter
		TextView savedCounter = (TextView) findViewById(R.id.counterLifetimeSaving);
		int savedTimes =  sharedPreferences.getInt("TIMESSAVED", 0);
		savedCounter.setText(savedTimes+ "");
		
		//Set the lifetime spent counter
		TextView spentCounter = (TextView) findViewById(R.id.counterLifetimeSpending);
		int spentTimes =  sharedPreferences.getInt("TIMESSPENT", 0);
		spentCounter.setText(spentTimes + "");		
		...
		futureValue= (float) (lifetimeSaving * Math.pow((1+interestRate),(20)));
		futureValue*=100;
		futureValue = Math.round(futureValue);
		futureValue/=100;					
		...
		futureValue= (float) (lifetimeSpending * Math.pow((1+interestRate),(20)));
		futureValue*=100;
		futureValue = Math.round(futureValue);
		futureValue/=100;					
		...
		futureValue= (float) (lifetimeSaving * Math.pow((1+interestRate),(retirementAge-age)));
		futureValue*=100;
		futureValue = Math.round(futureValue);
		futureValue/=100;					
		...
		futureValue= (float) (lifetimeSpending * Math.pow((1+interestRate),(retirementAge-age)));
		futureValue*=100;
		futureValue = Math.round(futureValue);
		futureValue/=100;					
